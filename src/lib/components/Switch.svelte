...
>
  ...
  />
  <div
    class="w-9 h-5 bg-secondary peer-focus-visible:ring-2 peer-focus-visible:ring-success/40 rounded-full transition-colors duration-200 ease-out {color} relative shadow-xs"
  >
    <div
